...
namespace OSGi.NET.Core
{
    ...
    /// 表示模块上下文，暴露了内核的操作
    /// </summary>
    internal class BundleContext : IBundleContext, IContextFireEvent
    {
        /// <summary>
        /// 框架内核
        /// </summary>
        ...
        {
            var sr = ((IFrameworkService)framework).RegisterService(this, contracts, service, properties);
            serviceReferenceList.Add(sr.GetReference());

            foreach (var bundleObj in framework.GetBundles())
            {
                var fireContext = (IContextFireEvent)bundleObj.GetBundleContext();
                fireContext.FireServiceChanged(bundle, new ServiceEventArgs(ServiceEventArgs.REGISTERED, contracts, sr.GetReference()));
            }
        ...
        public IServiceRegistration RegisterService<T>(object service, IDictionary<string, object> properties = null)
        {
            ...
            System.Diagnostics.Debug.WriteLine(service.GetType());
            return RegisterService(contract, _, properties);
        }
        ...
        public void UnRegisterService(IServiceReference serviceReference)
        {
            ...
            {
                var fireContext = (IContextFireEvent)bundleObj.GetBundleContext();
                fireContext.FireServiceChanged(bundle, new ServiceEventArgs(ServiceEventArgs.UNREGISTERING, serviceReference.GetSercieContracts(), serviceReference));
            }
        ...
        internal void Stop()
        {
            ...
            var bundleUsingServiceReferences = new IServiceReference[bundleUsingServiceReferenceList.Count];
        ...
        public void FireExtensionChanged(IBundle bundle, ExtensionEventArgs extensionEventArgs)
        {
            ...
            {
                ExtensionChanged(bundle, extensionEventArgs);
            }
        }
        ...
        public void FireServiceChanged(IBundle bundle, ServiceEventArgs serviceEventArgs)
        {
            ...
            {
                ServiceChanged(bundle, serviceEventArgs);
            }
        }
    }
}
